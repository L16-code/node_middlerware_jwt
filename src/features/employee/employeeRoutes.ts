...
import { createEmployee, getAllEmployees, getEmployee, updateEmployee } from "./employeecontroller";
...
router.delete('/employee/:id',verifyToken,validateRequest(employeeIdSchema,'params'),HandleErrors(updateEmployee))
